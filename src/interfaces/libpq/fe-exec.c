...
//added by gqx
char *
PQvovalue(const PGresult *res, int field_num){
     if(res->str){
         return res->str[field_num].name;
     }else{
         return NULL;
     }
}

bool PQisVoType(const PGresult *res){
    return res->isAuthType;
}
