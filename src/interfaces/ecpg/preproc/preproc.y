...
/* orig_tokens */
 ...
 ASSERTION ASSIGNMENT ASYMMETRIC AT AUTHORIZATION AUTHSELECT AUTHTABLE
...
|   CREATE OptTemp AUTHTABLE qualified_name '(' OptTableElementList ')' OptInherit OptWith OnCommitOption OptTableSpace
 {
 $$ = cat_str(12,make_str("create"),$2,make_str("authtable"),$4,make_str("("),$6,make_str(")"),$8,$9,$10,$11);
}
;
...
|  AUTHSELECT opt_distinct target_list into_clause from_clause where_clause
 { 
 $$ = cat_str(6,make_str("authselect"),$2,$3,$4,$5,$6);
}
;
