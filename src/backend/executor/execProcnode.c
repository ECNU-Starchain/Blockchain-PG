...
ExecInitNode(Plan *node, EState *estate, int eflags)
{
	...
	switch (nodeTag(node))
	{
        ...
        case T_AuthIndexScan:
            result = (PlanState *) ExecInitAuthSeqScan((AuthIndexScan *) node,
                                                         estate, eflags);
             break;
...
ExecProcNode(PlanState *node)
{
	...
	switch (nodeTag(node))
	{
        ...
        //added by gqx 2020/3/31
        case T_AuthIndexScanState:
            result = ExecAuthIndexScan((AuthIndexScanState *) node);
            break;
...
ExecCountSlotsNode(Plan *node)
{
	...
	switch (nodeTag(node))
	{
        ...
        case T_AuthIndexScan:
            return ExecCountSlotsAuthIndexScan((IndexScan *) node);
