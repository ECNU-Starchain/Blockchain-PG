...
SeqNext(SeqScanState *node)
{
    ...
    //modified bu gqx
//    TupleDesc tupleDescriptor;  //C:\Users\86216\Desktop\postgresql-8.4.1\src\backend\access\common\tupdesc.c:432
//    Datum **values;
//    Type targetType1 = typeidType(1043);
//    Type targetType2 = typeidType(1082);
//    Datum val[] = {stringTypeDatum(targetType1, "gqx", -1), stringTypeDatum(targetType2, "2020/3/24", -1)};
//    values = &val;
//    bool isnull[2] = {FALSE, FALSE};
//    tupleDescriptor = CreateTemplateTupleDesc(2, 0);
//    int i = 0;
//    char *rs[] = {"name", "signup_date"};
//    TupleDescInitEntry(tupleDescriptor, 1, rs[0], 1043, -1, 0);
//    TupleDescInitEntry(tupleDescriptor, 2, rs[1], 1082, -1, 0);
//    tuple = heap_form_tuple(tupleDescriptor, values, isnull);
