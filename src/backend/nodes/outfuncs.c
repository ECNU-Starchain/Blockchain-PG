...
static void
_outAuthOpExpr(StringInfo str, Auth_Op_Expr *node)
{
    WRITE_NODE_TYPE("Auth_Op_Expr");

    WRITE_NODE_FIELD(lexpr);
    WRITE_NODE_FIELD(rexpr);
    WRITE_INT_FIELD(authType);
}
static void
_outAuthExpr(StringInfo str, Auth_Expr *node)
{
    WRITE_NODE_TYPE("Auth_Expr");
...
_outNode(StringInfo str, void *obj)
{
	...
	else
	{
		...
		switch (nodeTag(obj))
		{
            ...
            //added by gqx 2020/3/30
            case T_Auth_Op_Expr:
                _outAuthOpExpr(str, obj);
                break;
            case T_Auth_Expr:
                _outAuthExpr(str, obj);
                break;
