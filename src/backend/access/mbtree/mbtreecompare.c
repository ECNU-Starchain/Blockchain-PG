 ...
 *
 * nmbtcompare.c
 *	  Comparison functions for mbtree access method.
 *
 ...
 *
 * IDENTIFICATION
 *	  $PostgreSQL: pgsql/src/backend/access/nmbtree/nmbtcompare.c,v 1.57 2009/01/01 17:23:35 momjian Exp $
 *
 * NOTES
 *
 *	These functions are stored in pg_amproc.  For each operator class
 *	defined on mbtrees, they compute
 *
 *				compare(a, b):
 *						< 0 if a < b,
 *						= 0 if a == b,
 ...
 *	three-way comparison code that the mbtree function does.  Therefore,
 *	this file contains only mbtree support for "trivial" datatypes ---
...
Datum
mbtoidvectorcmp(PG_FUNCTION_ARGS)
{
