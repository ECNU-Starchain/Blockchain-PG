                    ...
                    bool isvalid)
{
    ...
    //added by gqx
    if(indexInfo->isAuthType){
        values[Anum_pg_index_isauthtype - 1] = BoolGetDatum(true);
    }else{
        values[Anum_pg_index_isauthtype - 1] = BoolGetDatum(false);
    }
             ...
             bool concurrent)
{
    ...
    //added by gqx
    indexRelation->isAuthType = indexInfo->isAuthType;
...
BuildIndexInfo(Relation index)
{
    ...
    ii->isAuthType = index->isAuthType;
