...
{ 1259, {"isAuthType"},    16, -1,  1, 26, 0, -1, -1, true, 'p', 'c', true, false, false, true, 0, { 0 } }
...
DATA(insert ( 1259 isAuthType		16 -1 1  26 0 -1 -1 t p c t f f t 0 _null_));
...
{ 0, {"isAuthType"},		16, -1, 1, 15, 0, -1, -1, true, 'p', 'c', true, false, false, true, 0, { 0 } }
/*
 * isAuthType added by gqx
 */
