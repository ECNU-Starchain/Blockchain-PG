 ...
 */
//改动
DATA(insert OID = 3303 (  mbtree	5 1 t t t t t t t f t 0 mbtinsert mbtbeginscan mbtgettuple mbtgetbitmap mbtrescan mbtendscan mbtmarkpos mbtrestrpos mbtbuild mbtbulkdelete mbtvacuumcleanup mbtcostestimate mbtoptions  ));
DESCR("mbtree index access method");
#define mbt_AM_OID 3303
