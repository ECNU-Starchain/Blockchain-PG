...
DATA(insert (	398   2277 2277 1 8314 ));
DATA(insert (	422   702 702 1 8307 ));
DATA(insert (	419   1560 1560 1 1596 ));
DATA(insert (	420   16 16 1 8316 ));
DATA(insert (	425   1042 1042 1 1078 ));
DATA(insert (	430   17 17 1 1954 ));
DATA(insert (	432   18 18 1 8308 ));
DATA(insert (	436   1082 1082 1 1092 ));
DATA(insert (	436   1082 1114 1 2344 ));
DATA(insert (	436   1082 1184 1 2357 ));
DATA(insert (	436   1114 1114 1 2045 ));
DATA(insert (	436   1114 1082 1 2370 ));
DATA(insert (	436   1114 1184 1 2526 ));
DATA(insert (	436   1184 1184 1 1314 ));
DATA(insert (	436   1184 1082 1 2383 ));
DATA(insert (	436   1184 1114 1 2533 ));
DATA(insert (	1972   700 700 1 8303 ));
DATA(insert (	1972   700 701 1 8325 ));
DATA(insert (	1972   701 701 1 8304 ));
DATA(insert (	1972   701 700 1 8326 ));
DATA(insert (	1973   869 869 1 926 ));
DATA(insert (	1978   21 21 1 8300 ));
DATA(insert (	1978   21 23 1 8321 ));
DATA(insert (	1978   21 20 1 8323 ));
DATA(insert (	1978   23 23 1 8301 ));
DATA(insert (	1978   23 20 1 8319 ));
DATA(insert (	1978   23 21 1 8322 ));
DATA(insert (	1978   20 20 1 8302 ));
DATA(insert (	1978   20 23 1 8320 ));
DATA(insert (	1978   20 21 1 8324 ));
DATA(insert (	1981   1186 1186 1 1315 ));
DATA(insert (	2009   829 829 1 836 ));
DATA(insert (	1993   19 19 1 8309 ));
DATA(insert (	2003   1700 1700 1 1769 ));
// DATA(insert (	2008   26 26 1 8305 ));
// DATA(insert (	1998   30 30 1 8306 ));
DATA(insert (	2995   2249 2249 1 8331 ));
DATA(insert (	2004   25 25 1 8310 ));
DATA(insert (	2005   1083 1083 1 1107 ));
DATA(insert (	2007   1266 1266 1 1358 ));
DATA(insert (	2006   1562 1562 1 1672 ));
DATA(insert (	2242   25 25 1 8317 ));
DATA(insert (	2243   1042 1042 1 8318 ));
DATA(insert (	2100   790 790 1  377 ));
DATA(insert (	2241   703 703 1  8312 ));
DATA(insert (	2236   704 704 1  8313 ));
DATA(insert (	2790   27 27 1 8315 ));
DATA(insert (	2970   2950 2950 1 2960 ));
DATA(insert (	3524   3500 3500 1 3514 ));

// DATA(insert (	425   1042 1042 1 1080 ));
// DATA(insert (	432   18 18 1 454 ));
// DATA(insert (	436   1082 1082 1 450 ));
// DATA(insert (	1972   700 700 1 451 ));
// DATA(insert (	1972   701 701 1 452 ));
// DATA(insert (	1973   869 869 1 422 ));
// DATA(insert (	1978   21 21 1 449 ));
// DATA(insert (	1978   23 23 1 450 ));
// DATA(insert (	1978   20 20 1 949 ));
// DATA(insert (	1981   1186 1186 1 1697 ));
// DATA(insert (	2009   829 829 1 399 ));
// DATA(insert (	1993   19 19 1 455 ));
// //DATA(insert (	2008   26 26 1 453 ));
// //DATA(insert (	1998   30 30 1 457 ));
// DATA(insert (	2004   25 25 1 400 ));
// DATA(insert (	2005   1083 1083 1 1688 ));
// DATA(insert (	2003   1700 1700 1 432 ));
// DATA(insert (	2006   1184 1184 1 2039 ));
// DATA(insert (	2007   1266 1266 1 1696 ));
// DATA(insert (	2041   1114 1114 1 2039 ));
// DATA(insert (	2230   16 16 1 454 ));
// DATA(insert (	2236   17 17 1 456 ));
// DATA(insert (	2237   22 22 1 398 ));
// DATA(insert (	2238   28 28 1 450 ));
// DATA(insert (	2239   29 29 1 450 ));
// DATA(insert (	2240   702 702 1 450 ));
// DATA(insert (	2241   703 703 1 450 ));
// DATA(insert (	2242   25 25 1 400 ));
// DATA(insert (	2243   1042 1042 1 1080 ));
// DATA(insert (	2244   1033 1033 1 329 ));
// DATA(insert (	2970   2950 2950 1 2963 ));
// DATA(insert (	3524   3500 3500 1 3515 ));
