...
//改动
DATA(insert (	3303		bpchar_ops			PGNSP PGUID  425 1042 t 0 ));
DATA(insert (	3303		char_ops			PGNSP PGUID  432   18 t 0 ));
DATA(insert (	3303		cidr_ops			PGNSP PGUID 1973  869 f 0 ));
DATA(insert (	3303		date_ops			PGNSP PGUID  436 1082 t 0 ));
DATA(insert (	3303		float4_ops			PGNSP PGUID 1972  700 t 0 ));
DATA(insert (	3303		float8_ops			PGNSP PGUID 1972  701 t 0 ));
DATA(insert (	3303		inet_ops			PGNSP PGUID 1973  869 t 0 ));
DATA(insert (	3303		int2_ops			PGNSP PGUID 1978   21 t 0 ));
DATA(insert (	3303		int4_ops			PGNSP PGUID 1978   23 t 0 ));
DATA(insert (	3303		int8_ops			PGNSP PGUID 1978   20 t 0 ));
DATA(insert (	3303		interval_ops		PGNSP PGUID 1981 1186 t 0 ));
DATA(insert (	3303		macaddr_ops			PGNSP PGUID 2009  829 t 0 ));
DATA(insert (	3303		name_ops			PGNSP PGUID 1993   19 t 0 ));
DATA(insert (	3303		numeric_ops			PGNSP PGUID 2003 1700 t 0 ));
//DATA(insert (	3303		oid_ops				PGNSP PGUID 2008   26 t 0 ));
//DATA(insert (	3303		oidvector_ops		PGNSP PGUID 1998   30 t 0 ));
DATA(insert (	3303		text_ops			PGNSP PGUID 2004   25 t 0 ));
DATA(insert (	3303		time_ops			PGNSP PGUID 2005 1083 t 0 ));
DATA(insert (	3303		timestamptz_ops		PGNSP PGUID 2006 1184 t 0 ));
DATA(insert (	3303		timetz_ops			PGNSP PGUID 2007 1266 t 0 ));
DATA(insert (	3303		varchar_ops			PGNSP PGUID 2004   25 f 0 ));
DATA(insert (	3303		timestamp_ops		PGNSP PGUID 2041 1114 t 0 ));
DATA(insert (	3303		bool_ops			PGNSP PGUID 2230   16 t 0 ));
DATA(insert (	3303		bytea_ops			PGNSP PGUID 2236   17 t 0 ));
DATA(insert (	3303		int2vector_ops		PGNSP PGUID 2237   22 t 0 ));		
DATA(insert (	3303		xid_ops				PGNSP PGUID 2238   28 t 0 ));
DATA(insert (	3303		cid_ops				PGNSP PGUID 2239   29 t 0 ));
DATA(insert (	3303		abstime_ops			PGNSP PGUID 2240  702 t 0 ));
DATA(insert (	3303		reltime_ops			PGNSP PGUID 2241  703 t 0 ));
DATA(insert (	3303		text_pattern_ops	PGNSP PGUID 2242   25 f 0 ));
DATA(insert (	3303		varchar_pattern_ops PGNSP PGUID 2242   25 f 0 ));
DATA(insert (	3303		bpchar_pattern_ops	PGNSP PGUID 2243 1042 f 0 ));
DATA(insert (	3303		aclitem_ops			PGNSP PGUID 2244 1033 t 0 ));
DATA(insert (	3303		uuid_ops			PGNSP PGUID 2970  2950 t 0 ));
DATA(insert (	3303		enum_ops			PGNSP PGUID 3524  3500 t 0 ));
