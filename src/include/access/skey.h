...
#define mbtLessStrategyNumber			6
#define mbtLessEqualStrategyNumber		7
#define mbtEqualStrategyNumber			8
#define mbtGreaterEqualStrategyNumber	9
#define mbtGreaterStrategyNumber			10

#define mbtMaxStrategyNumber				10
