...
extern bool mbt_index_insert(Relation indexRelation,
             pg_index_info* values,
             ItemPointer heap_t_ctid,
             Relation heapRelation);
...
extern mypgvo auth_index_getnext(IndexScanDesc scan, Relation indexRelation, int left, int right);
