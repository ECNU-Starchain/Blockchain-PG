...
//改动
extern Datum mbtboolcmp(PG_FUNCTION_ARGS);
extern Datum mbtint2cmp(PG_FUNCTION_ARGS);
extern Datum mbtint4cmp(PG_FUNCTION_ARGS);
extern Datum mbtint8cmp(PG_FUNCTION_ARGS);
extern Datum mbtfloat4cmp(PG_FUNCTION_ARGS);
extern Datum mbtfloat8cmp(PG_FUNCTION_ARGS);
extern Datum mbtint48cmp(PG_FUNCTION_ARGS);
extern Datum mbtint84cmp(PG_FUNCTION_ARGS);
extern Datum mbtint24cmp(PG_FUNCTION_ARGS);
extern Datum mbtint42cmp(PG_FUNCTION_ARGS);
extern Datum mbtint28cmp(PG_FUNCTION_ARGS);
extern Datum mbtint82cmp(PG_FUNCTION_ARGS);
extern Datum mbtfloat48cmp(PG_FUNCTION_ARGS);
extern Datum mbtfloat84cmp(PG_FUNCTION_ARGS);
extern Datum mbtoidcmp(PG_FUNCTION_ARGS);
extern Datum mbtoidvectorcmp(PG_FUNCTION_ARGS);
extern Datum mbtabstimecmp(PG_FUNCTION_ARGS);
extern Datum mbtreltimecmp(PG_FUNCTION_ARGS);
extern Datum mbttintervalcmp(PG_FUNCTION_ARGS);
extern Datum mbtcharcmp(PG_FUNCTION_ARGS);
extern Datum mbtnamecmp(PG_FUNCTION_ARGS);
extern Datum mbttextcmp(PG_FUNCTION_ARGS);
...
extern Datum mbtrecordcmp(PG_FUNCTION_ARGS);
...
extern Datum mbttidcmp(PG_FUNCTION_ARGS);
...
extern Datum mbtbpchar(PG_FUNCTION_ARGS);
...
extern Datum mbtbpchar_pattern_cmp(PG_FUNCTION_ARGS);
...
extern Datum mbttext_pattern_cmp(PG_FUNCTION_ARGS);
...
extern Datum mbtinet(PG_FUNCTION_ARGS);
...
extern Datum mbtmacaddr(PG_FUNCTION_ARGS);
...
extern Datum mbt_numeric(PG_FUNCTION_ARGS);
...
extern Datum uuid_mbt(PG_FUNCTION_ARGS);
